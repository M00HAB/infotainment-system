...
Q_CONSTINIT static const uint qt_meta_data_ZN11MusicPlayerE[] = {
 ...
 // signals: name, argc, parameters, tag, flags, initial metatype offsets
       ...
       4,    1,   77,    2, 0x06,    6 /* Public */,
       6,    0,   80,    2, 0x06,    8 /* Public */,

 // methods: name, argc, parameters, tag, flags, initial metatype offsets
       7,    1,   81,    2, 0x02,    9 /* Public */,
       9,    0,   84,    2, 0x02,   11 /* Public */,
      10,    0,   85,    2, 0x02,   12 /* Public */,
      11,    0,   86,    2, 0x02,   13 /* Public */,
      12,    0,   87,    2, 0x02,   14 /* Public */,
      13,    1,   88,    2, 0x02,   15 /* Public */,
      15,    1,   91,    2, 0x02,   17 /* Public */,
...
void MusicPlayer::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::IndexOfMethod) {
        ...
        {
            using _q_method_type = void (MusicPlayer::*)(qint64 );
            if (_q_method_type _q_method = &MusicPlayer::positionChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (MusicPlayer::*)(qint64 );
            if (_q_method_type _q_method = &MusicPlayer::durationChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (MusicPlayer::*)();
            if (_q_method_type _q_method = &MusicPlayer::songNameChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
    ...
    if (_c == QMetaObject::ReadProperty) {
        ...
        case 2: *reinterpret_cast< QString*>(_v) = _t->songName(); break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setPosition(*reinterpret_cast< qint64*>(_v)); break;
        default: break;
        }
    }
}
