...
static constexpr auto qt_meta_stringdata_ZN15MusicControllerE = QtMocHelpers::stringData(
    "MusicController",
    "currentFMStationChanged",
    "",
    "connectedDeviceNameChanged",
    "spotifyConnectedChanged",
    "currentFMStation",
    "connectedDeviceName",
    "spotifyConnected"
);
...
void MusicController::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    ...
    if (_c == QMetaObject::InvokeMetaMethod) {
        switch (_id) {
        case 0: _t->currentFMStationChanged(); break;
        case 1: _t->connectedDeviceNameChanged(); break;
        case 2: _t->spotifyConnectedChanged(); break;
        default: ;
        }
    }
    if (_c == QMetaObject::IndexOfMethod) {
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (_q_method_type _q_method = &MusicController::currentFMStationChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 0;
                return;
            }
        }
        {
            using _q_method_type = void (MusicController::*)();
            if (_q_method_type _q_method = &MusicController::connectedDeviceNameChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 1;
                return;
            }
        }
        {
            using _q_method_type = void (MusicController::*)();
            if (_q_method_type _q_method = &MusicController::spotifyConnectedChanged; *reinterpret_cast<_q_method_type *>(_a[1]) == _q_method) {
                *result = 2;
                return;
            }
        }
    ...
    if (_c == QMetaObject::ReadProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: *reinterpret_cast< double*>(_v) = _t->currentFMStation(); break;
        case 1: *reinterpret_cast< QString*>(_v) = _t->connectedDeviceName(); break;
        case 2: *reinterpret_cast< bool*>(_v) = _t->spotifyConnected(); break;
        default: break;
        }
    }
    if (_c == QMetaObject::WriteProperty) {
        void *_v = _a[0];
        switch (_id) {
        case 0: _t->setCurrentFMStation(*reinterpret_cast< double*>(_v)); break;
        case 1: _t->setConnectedDeviceName(*reinterpret_cast< QString*>(_v)); break;
        case 2: _t->setSpotifyConnected(*reinterpret_cast< bool*>(_v)); break;
        default: break;
        }
    }
}
...
// SIGNAL 0
void MusicController::currentFMStationChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 0, nullptr);
}

// SIGNAL 1
void MusicController::connectedDeviceNameChanged()
{
    QMetaObject::activate(this, &staticMetaObject, 1, nullptr);
}

// SIGNAL 2
void MusicController::spotifyConnectedChanged()
{
